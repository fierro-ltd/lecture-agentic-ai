...
_DEFAULT_KEY = "edu-platform-test-key-2026"
...
class Settings:
    ...
    HERMES_API_KEY: str = os.getenv("HERMES_API_KEY", _DEFAULT_KEY)
    HAST_API_KEY: str = os.getenv("HAST_API_KEY", os.getenv("HERMES_API_KEY", _DEFAULT_KEY))
...
if settings.HAST_API_KEY == _DEFAULT_KEY:
    logger.warning("HAST_API_KEY is using the default dev key — set a secure key in production")
